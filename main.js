...
.then(data => {                     
    ...
    long = data[0].lon;                                                 // get the location longitude for Helsingborg stad.
        ...
        .then(data => {
            ...
            let feelLike = data.main.feels_like;                        // we feel the temperature like.
            // icon = data.weather[0].main;                             // git the icon from data. 
            ...
            console.log(icon);           
                                                                                            ...
                                                                                            // Add the time and the date for today .. 
                const date = new Date();
                console.log(date);
                let time = date.getHours();
                let minuts = date.getMinutes();
                let showTime = `${time} : ${minuts}`;
                document.getElementById('timeNow').innerHTML = showTime;
                console.log(time);
